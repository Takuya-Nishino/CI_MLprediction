...
# %% [markdown]
# # ② Secondary and sensitivity analyses — BMC MIDM / Methods-aligned / Standalone FULL
#
# Run after Notebook 01. Performs paired Day 3 vs Day 7 analyses in the same Day 7-eligible population and the Methods-specified Day 7 LOS >28-day sensitivity analysis. Optional Day 3 LOS >28-day and death-exclusion analyses remain disabled unless explicitly enabled and reported.
#
...
# %% [markdown]
# ## Execute this notebook stage

# %% 
with threadpool_limits(limits=1):
    SENSITIVITY_RESULTS = run_sensitivity_stage(CONFIG)
